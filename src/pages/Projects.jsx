...
import image3 from '../assets/Screenshot 5.png'
  ...
  return (
    <section id='project' className='px-5'>
      ...
      <div className='w-[360px] h-72 bg-slate-700 rounded-lg p-4'>
        ...
        <div>  <a href="https://pughaz.netlify.app" className='h-5 w-14 px-4 py-2 rounded-lg bg-white'>view</a></div>
       </div>
       </div>
      ...
      <img src={image3} alt="" /> 
      <div className='mt-7 flex justify-between'>
      <h1 className='text-xl text-white'>Legal-Ease</h1>
        <div><a href="https://github.com/pughaz2003/Legalease.git" className='h-5 w-14 px-4 py-2 rounded-lg bg-white'>view</a></div>
       </div>
</div>
<div className='w-[360px] h-72 bg-slate-700 rounded-lg p-4'>
      <img src={image4} alt="" />
      ...
      <div>
      <a href="https://github.com/pughaz2003/Instagram-UI-clone.git" className='h-5 w-14 px-4 py-2 rounded-lg  bg-white'>view</a>
      </div>
